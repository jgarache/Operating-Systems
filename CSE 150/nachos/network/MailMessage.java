...
public class MailMessage {
  ...
  public static final int maxSeqNum = Integer.MAX_VALUE;
   ...
   */
  public MailMessage(
      int dstLink, int dstPort, int srcLink, int srcPort, int seqNum, byte[] contents)
    ...
    byte[] seqNumByte = Lib.bytesFromInt(seqNum);
    System.arraycopy(seqNumByte, 0, packetContents, 4, seqNumByte.length);
